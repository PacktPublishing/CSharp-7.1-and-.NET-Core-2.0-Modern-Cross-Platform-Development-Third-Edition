...
namespace NorthwindUwp.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<AngularWebViewPage>("Shell_AngularWebView".GetLocalized(), Symbol.Globe));
            _primaryItems.Add(ShellNavigationItem.FromType<CategoryMasterDetailPage>("Shell_CategoryMasterDetail".GetLocalized(), Symbol.ContactInfo));
            _primaryItems.Add(ShellNavigationItem.FromType<CustomersGridPage>("Shell_CustomersGrid".GetLocalized(), Symbol.PhoneBook));
            _primaryItems.Add(ShellNavigationItem.FromType<CustomerMapPage>("Shell_CustomerMap".GetLocalized(), Symbol.Map));
            _primaryItems.Add(ShellNavigationItem.FromType<AboutNorthwindAppPage>("Shell_AboutNorthwindApp".GetLocalized(), Symbol.Help));
